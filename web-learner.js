...
const WHITELIST_DOMAINS = ['wikipedia.org','stackoverflow.com','github.com','bbc.com','developer.mozilla.org','arxiv.org','openai.com'];
...
async function startLearning() {
    ...
    console.log('Web learning completed.');
}

// Export function for server.js or manual run
